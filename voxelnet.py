...
class VoxelNet(nn.Module):
    ...
    def forward(self, example):
        ...
        indexes_vect = example["indexes_vect"]
        coors = example["coordinates"]
        num_points_voxel = example["num_points_voxel"]
        coors_pontos = example["coors_pontos"]
        ...
        # coors: [num_voxels, 4]
        voxel_features = self.voxel_feature_extractor(voxels, indexes_vect, coors, num_points_voxel,coors_pontos)
